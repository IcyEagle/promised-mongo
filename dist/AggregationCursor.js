...
var _Cursor2 = require('./Cursor.js');
...
var AggregationCursor = function (_Cursor) {
  ...
  function AggregationCursor(collection, config) {
    ...
    return _possibleConstructorReturn(this, (AggregationCursor.__proto__ || Object.getPrototypeOf(AggregationCursor)).call(this, collection, config));
  }
